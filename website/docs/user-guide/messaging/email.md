...
sidebar_position: 7
title: "Email"
description: "Set up Jolly LLB as an email assistant via IMAP/SMTP"
---
...
|---|---|---|
| Let people email the Jolly LLB and receive replies | Email gateway adapter on this page | None beyond an IMAP/SMTP email account |
...
- **A dedicated email account** for your Jolly LLB (don't use your personal email)
