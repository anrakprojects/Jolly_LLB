...
description: "Use Jolly LLB inside ACP-compatible editors such as VS Code, Zed, and JetBrains"
---

# ACP Editor Integration

Jolly LLB can run as an ACP server, letting ACP-compatible editors talk to Hermes over stdio and render:
...
2. Select **Jolly LLB** from the built-in agent list.
...
- In Zed, open the ACP Registry with `zed: acp registry` and search for **Jolly LLB**.
...
Install `uv` from the official uv installation docs, then retry the Jolly LLB thread from Zed.
