...
description: "A practical guide to connecting MCP servers to Jolly LLB, filtering their tools, and using them safely in real workflows"
---

# Use MCP with Hermes

This guide shows how to actually use MCP with Jolly LLB in day-to-day workflows.
