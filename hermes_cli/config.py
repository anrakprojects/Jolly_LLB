"""
Configuration management for Jolly LLB.
...
Jolly LLB runs as a published image (nousresearch/hermes-agent), not a
...
DEFAULT_CONFIG = {
    ...
    "whatsapp": {
        ...
        # Default (None) uses the built-in "⚕ *Jolly LLB*" header.
    ...
    "model_catalog": {
        "enabled": True,
        "url": "https://raw.githubusercontent.com/anrakprojects/Jolly_LLB/main/website/static/api/model-catalog.json",
