...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Jolly LLB"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Jolly LLB"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Jolly LLB",
            "welcome": "Welcome to Jolly LLB! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
