...
- **Local Web Dashboard** — A new browser-based dashboard for managing your Jolly LLB locally. Configure settings, monitor sessions, browse skills, and manage your gateway — all from a clean web interface without touching config files or the terminal. The easiest way to get started with Hermes.
