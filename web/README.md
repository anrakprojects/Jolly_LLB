...
Browser-based dashboard for managing Jolly LLB configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Jolly LLB” — mixed case, no Mondwest, no `text-display` |
