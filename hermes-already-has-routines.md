# Jolly LLB Has Had "Routines" Since March
...
| | Claude Code Routines | Jolly LLB |
|---|---|---|
...
Jolly LLB is open source and free. The automation infrastructure — cron scheduler, webhook platform, skill system, multi-platform delivery — is built in.
...
*Jolly LLB is built by [Nous Research](https://nousresearch.com). Open source, model-agnostic, runs on your infrastructure.*
